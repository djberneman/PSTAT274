...
Time series {X~t~} follows stationary AR(1) model X~t~ = $\phi_0$ + $\phi_1$X~t−1~ + Z~t~, Z~t~ ∼ N(0, σ~Z~^2^). Determine which of the following statements about this model is false.\
  ...
  - TRUE. If $\phi_1=0$, then the equation of the model is simplified to $X_t=\phi_0+Z_t
...
2. (Updating forecasts) You use AR(1) model Xt − 100 = 0.6(Xt−1 − 100) + Zt to represent a time series of 100 observations. You are given that X100 = 110. You later observe X101 = 95. Calculate
P101X103 − P100X103.
