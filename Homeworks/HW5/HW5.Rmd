...
# Mortality models
# Model 1
Mortality_model1 <- auto.arima(Mortality, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = TRUE)
...
acf2(Mortality_model1$residuals, max.lag = 400)

plot.ts(Mortality, lwd=4)
points(Mortality_model1$fitted, type="l", col="red")

# Model 2
Mortality_model2 <- auto.arima(Mortality, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE)

Mortality_model2$coef

polyroot(c(1, Mortality_model2$coef[1], Mortality_model2$coef[2]))

acf2(Mortality_model2$residuals, max.lag = 400)
...
# Model 1
Rolling_Mortality_model1 <- auto.arima(Rolling_Mortality, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = TRUE)
...
acf2(Rolling_Mortality_model1$residuals, max.lag = 400)

plot.ts(Rolling_Mortality, lwd=4)
points(Rolling_Mortality_model1$fitted, type="l", col="red")

# Model 2
Rolling_Mortality_model2 <- auto.arima(Rolling_Mortality, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE)

Rolling_Mortality_model2$coef

acf2(Rolling_Mortality_model2$residuals, max.lag = 400)
...
# Deaths Models
# Model 1
Deaths_model1 <- auto.arima(Deaths, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = TRUE)

Deaths_model1$coef

polyroot(c(1, Deaths_model1$coef[1], Deaths_model1$coef[2], Deaths_model1$coef[3], Deaths_model1$coef[4], Deaths_model1$coef[5]))

acf2(Deaths_model1$residuals, max.lag = 400)

plot.ts(Deaths, lwd=4)
points(Deaths_model1$fitted, type="l", col="red")

# Model 2
Deaths_model2 <- auto.arima(Deaths, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, stepwise=FALSE, approximation=FALSE)
...
acf2(Deaths_model2$residuals, max.lag = 400)
...
Deaths_model3 <- auto.arima(Deaths, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = TRUE, fixed=c(Deaths_model2$coef[1]+.01, Deaths_model2$coef[2]-.005, Deaths_model2$coef[3]+.015, Deaths_model2$coef[4]-.023, mu = Deaths_model2$coef[5]), stepwise=FALSE, approximation=FALSE)
...
acf2(Deaths_model3$residuals, max.lag = 400)
...
Mortality_box <- auto.arima(Mortality.bc, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE)

# # This is a pure MA(5) model which is always stationary
Mortality_box$coef

acf2(Mortality_box$residuals, max.lag = 1200)

#log transform
Mortality.log = log(Mortality)
Mortality_log <- auto.arima(Mortality.log, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE)

# # This is a pure MA(5) model which is always stationary
Mortality_log$coef

acf2(Mortality_log$residuals, max.lag=1200)

# square root transform
Mortality.sqrt = sqrt(Mortality)
Mortality_sqrt <- auto.arima(Mortality.sqrt, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE)

# # This is a pure MA(5) model which is always stationary
Mortality_sqrt$coef

acf2(Mortality_sqrt$residuals, max.lag = 1200)
...
Rolling_Mortality_box <- auto.arima(Rolling_Mortality.bc, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE)

Rolling_Mortality_box$coef

acf2(Rolling_Mortality_box$residuals, max.lag = 800)

#log transform
Rolling_Mortality.log = log(Rolling_Mortality)
Rolling_Mortality_log <- auto.arima(Rolling_Mortality.log, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE)

Rolling_Mortality_log$coef

acf2(Rolling_Mortality_log$residuals, max.lag=800)

# square root transform
Rolling_Mortality.sqrt = sqrt(Rolling_Mortality)
Rolling_Mortality_sqrt <- auto.arima(Rolling_Mortality.sqrt, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE)
...
Deaths_sqrt <- auto.arima(Deaths.sqrt, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE)

Deaths_sqrt$coef

acf2(Deaths_sqrt$residuals, max.lag = 800)
...
plot(arima.sim(model = list(ar = c(Deaths_model2$coef[1]+.01, Deaths_model2$coef[2]-.005, Deaths_model2$coef[3]+.015, Deaths_model2$coef[4]-.023)), n=1214, innov= Deaths_model2$residuals, n.start=4)+Deaths_model2$coef[5], ylim=c(0,82000))
points(Deaths, type="l",col="red")

plot(arima.sim(model = list(ar = c(Deaths_model2$coef[1], Deaths_model2$coef[2], Deaths_model2$coef[3], Deaths_model2$coef[4])), n=1214, innov= Deaths_model2$residuals, n.start=4)+Deaths_model2$coef[5], ylim=c(0,82000))
points(Deaths, type="l",col="red")
```
\
