...
```{r}
ARIMA_model_1 <- auto.arima(Fatality_Rate, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = TRUE, trace = TRUE)$coef

polyroot(c(1, ARIMA_model_1[1], ARIMA_model_1[2], ARIMA_model_1[3], ARIMA_model_1[4], ARIMA_model_1[5]))


ARIMA_model_2 <- auto.arima(Fatality_Rate, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = FALSE, trace = TRUE)$coef

polyroot(c(1, ARIMA_model_2[1], ARIMA_model_2[2], ARIMA_model_2[3], ARIMA_model_2[4], ARIMA_model_2[5]))


ARIMA_model_3 <- auto.arima(Fatality_Rate, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)

polyroot(c(1, ARIMA_model_1[1], ARIMA_model_1[2], ARIMA_model_1[3], ARIMA_model_1[4], ARIMA_model_1[5]))


ARIMA_model_4 <- auto.arima(Fatality_Rate, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = FALSE, trace = TRUE)$coef



ARIMA_model_1 <- auto.arima(deaths1, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = TRUE, trace = TRUE)$coef

polyroot(c(1, ARIMA_model_1[1], ARIMA_model_1[2], ARIMA_model_1[3], ARIMA_model_1[4], ARIMA_model_1[5]))


ARIMA_model_2 <- auto.arima(deaths1, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = FALSE, trace = TRUE)$coef

polyroot(c(1, ARIMA_model_2[1], ARIMA_model_2[2], ARIMA_model_2[3], ARIMA_model_2[4], ARIMA_model_2[5]))


ARIMA_model_3 <- auto.arima(deaths1, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)

polyroot(c(1, ARIMA_model_1[1], ARIMA_model_1[2], ARIMA_model_1[3], ARIMA_model_1[4], ARIMA_model_1[5]))


ARIMA_model_4 <- auto.arima(deaths1, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = FALSE, trace = TRUE)$coef
...
polyroot(c(1, coef[1], coef[2], coef[3], coef[4], coef[5]))

ARIMA_model1 <- auto.arima(Fatality_Rate, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)


ARIMA_model2 <- auto.arima(deaths1, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary = TRUE, seasonal=TRUE)
...
ts.plot(Fatality_Rate.bc, main = "Box-Cox Transform") 
ts.plot(Fatality_Rate.log, main = "Log Transform") 
ts.plot(Fatality_Rate.sqrt, main = "Square Root Transform")
...
```
\
For both series, I attempted boxcox, square root, and log transformations. Some of them failed to work, while others would provide me with a series that when estimating the ARIMA order and coefficients, I would get an ARMA(0,0). For the ones the provided me with a legitimate ARIMA model, I used the polyroot function with the estimated coefficients to see if the series was stationary, but none of them were.  
