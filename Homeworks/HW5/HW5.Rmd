...
acf23 = acf2(fit.arma23$residuals)
acf24 = acf2(fit.arma24$residuals)

acf25 = acf2(arima(Mortality.diff, order=c(5,0,5))$residuals)
...
# Mortality models
# Model 1
Mortality_model1 <- auto.arima(Mortality.diff, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = TRUE, trace = TRUE)
