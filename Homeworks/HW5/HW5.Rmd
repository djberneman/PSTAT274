...
Fatality_Rate = ts(Rolling_Fatality, start = c(2021, 14))
...
```{r}
ARIMA_modelF_1 <- auto.arima(Fatality_Rate, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = TRUE, trace = TRUE)

polyroot(c(1, ARIMA_modelF_1$coef[1], ARIMA_modelF_1$coef[2], ARIMA_modelF_1$coef[3], ARIMA_modelF_1$coef[4], ARIMA_modelF_1$coef[5]))


ARIMA_modelF_2 <- auto.arima(Fatality_Rate, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = FALSE, trace = TRUE)

polyroot(c(1, ARIMA_modelF_2$coef[1], ARIMA_modelF_2$coef[2], ARIMA_modelF_2$coef[3], ARIMA_modelF_2$coef[4], ARIMA_modelF_2$coef[5]))


ARIMA_modelF_3 <- auto.arima(Fatality_Rate, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)

polyroot(c(1, ARIMA_modelF_1$coef[1], ARIMA_modelF_1$coef[2], ARIMA_modelF_1$coef[3], ARIMA_modelF_1$coef[4], ARIMA_modelF_1$coef[5]))


ARIMA_modelF_4 <- auto.arima(Fatality_Rate, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = FALSE, trace = TRUE)$coef



ARIMA_model_1 <- auto.arima(deaths2, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = TRUE, trace = TRUE)

polyroot(c(1, ARIMA_model_1$coef[1], ARIMA_model_1$coef[2], ARIMA_model_1$coef[3], ARIMA_model_1$coef[4], ARIMA_model_1$coef[5]))


ARIMA_model_2 <- auto.arima(deaths2, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = FALSE, trace = TRUE)

polyroot(c(1, ARIMA_model_2$coef[1], ARIMA_model_2$coef[2], ARIMA_model_2$coef[3], ARIMA_model_2$coef[4], ARIMA_model_2$coef[5]))


ARIMA_model_3 <- auto.arima(deaths2, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)

polyroot(c(1, ARIMA_model_3$coef[1], ARIMA_model_3$coef[2], ARIMA_model_3$coef[3], ARIMA_model_3$coef[4]))


ARIMA_model_4 <- auto.arima(deaths2, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = FALSE, trace = TRUE)

polyroot(c(1, ARIMA_model_4$coef[1], ARIMA_model_4$coef[2], ARIMA_model_4$coef[3], ARIMA_model_4$coef[4]))


ARIMA_model1 <- auto.arima(Fatality_Rate, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)


ARIMA_model2 <- auto.arima(deaths1, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary = TRUE, seasonal=TRUE, trace=TRUE)

polyroot(c(1, ARIMA_model2$coef[1], ARIMA_model2$coef[2], ARIMA_model2$coef[3], ARIMA_model2$coef[4]))

t = 1:length(resid)
fit = lm(resid ~ t)
bcTransform = boxcox(resid ~ t,plotit = TRUE)

lambda = bcTransform$x[which(bcTransform$y == max(bcTransform$y))] 
resid.bc = (1/lambda)*(resid^lambda-1)

ARIMA_model1_box <- auto.arima(resid.bc, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)

#log transform
resid.log = log(resid)
ARIMA_model1_log <- auto.arima(resid.log, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)


# square root transform
resid.sqrt = sqrt(resid)
ARIMA_model1_sqrt <- auto.arima(resid.sqrt, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)

coef_1 = ARIMA_model1_sqrt$coef

polyroot(c(1, coef_1[1], coef_1[2], coef_1[3], coef_1[4]))


#log transform
deaths1.log = log(deaths1)

#No suitable arima models found
# ARIMA_model2_log <- auto.arima(deaths1.log, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)

# square root transform
deaths1.sqrt = sqrt(deaths1)

ARIMA_model2_sqrt <- auto.arima(deaths1.sqrt, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)

x = ARIMA_model2_sqrt$coef
...
polyroot(c(1, ARIMA_model_4[1]+.01, ARIMA_model_4[2]-.005, ARIMA_model_4[3]+.015, ARIMA_model_4[4]-.023))
```
\
...
```{r}
acf2(ARIMA_model_4$residuals , max.lag = 50)
acf2(deaths2 , max.lag = 50)
deaths
```
