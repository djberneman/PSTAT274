...
auto.arima(Fatality_Rate, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary = TRUE, seasonal=TRUE)

auto.arima(Fatality_Rate, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=FALSE, seasonal = TRUE)

auto.arima(Fatality_Rate, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary = TRUE, seasonal = FALSE)
...
deaths1 = ts(covid$new_deaths, start = c(2020,3), frequency=365)
deaths2 = ts(covid$new_deaths, start = c(2020,3))
covid_world[is.na(covid_world)] <- 0
deaths1[is.na(deaths)] <- 0
deaths2[is.na(deaths)] <- 0
...
auto.arima(deaths1, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary = TRUE, seasonal = FALSE)$coef


plot(stl(deaths, s.window="periodic"))
cases <- covid[c("date", "new_cases_smoothed")]
deaths <- covid[c("date", "new_deaths")]
deaths_smoothed <- covid[c("date", "new_deaths_smoothed")]
ts()

auto_arima1 = auto.arima(deaths, trace = TRUE, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary = TRUE, seasonal=TRUE)

auto_arima2 = auto.arima(deaths, trace = TRUE, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, seasonal=FALSE)
...
plot(decompose(deaths))
plot.ts(ts(deaths$new_deaths, start = c(2020, 3), frequency=365))
plot.ts(ts(covid$new_deaths_smoothed, start = 2020, frequency=365))
plot(covid_cases_deat
 "new_deaths_smoothed")]
ts.plot(x=covid_cases_deaths$date, y=covid_cases_deaths$new_cases_smoothed)
```
