...
Mortality_model3 <- auto.arima(Mortality, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)

polyroot(c(1, Mortality_model3$coef[1], Mortality_model3$coef[2]))

acf2(Mortality_model3$residuals, max.lag = 400)
...
Rolling_Mortality_model3 <- auto.arima(Rolling_Mortality, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)
...
Deaths_model3 <- auto.arima(Deaths, start.p = 0, start.q = 0, start.P = 0, start.Q = 0, stationary=TRUE, seasonal = TRUE, trace = TRUE)
...
polyroot(c(1, Deaths_model3$coef[1]+.01, Deaths_model3$coef[2]-.005, Deaths_model3$coef[3]+.015, Deaths_model3$coef[4]-.023))
```
\
...
```{r}
acf2(Deaths_model4$residuals , max.lag = 50)
acf2(Deaths , max.lag = 50)
deaths
```
