...
&\text{Sample Mean: }\bar{X}_n \\\\
&\text{Confidence Interval: For n large, distribution of the sample mean }\bar{X}_n\\
...
$$
```{r}
acf(model=list(ar=(0.6)), type="covariance", plot=FALSE)
polyroot(c(1, 0.6))
```
