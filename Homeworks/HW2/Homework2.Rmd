...
&=E[e^{\ \lambda X}]^n\\\\
M(t) = &E[e^{Xt}]= e^{µt +\frac{1}{2}\sigma^2t^2}\ \ \ \ \rightarrow\ \ \ \
M(\lambda) = E[e^{X\lambda}] = e^{µ\lambda +\frac{1}{2}\sigma^2\lambda^2}\\\\
µ\  =\ & E[X_{t}]\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \sigma^2=Var[X_{t}]\\ 
=\ & E[Z_{t}+\theta Z_{t-1}]\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ = Var[Z_{t}] + \theta^2\ Var[Z_{t-1}] + 2\theta\ Cov[Z_{t},\ Z_{t-1}]\\
=\ & E[Z_{t}]+E[\theta Z_{t-1}]\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ = \sigma_{Z}^2 + \theta\ \sigma_{Z}^2\\
=\ & 0\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ = \sigma_{Z}^2(1+\theta)\\\\
M(\lambda) &= e^{\ 0\ *\ µ\ +\ \frac{1}{2}\sigma_{Z}^2(1+\theta)\lambda^2} = e^{\frac{1}{2}\sigma_{Z}^2(1+\theta)\lambda^2}  \\\\
E[&e^{\ \lambda X}]^n\ =\ [e^{\frac{1}{2}\sigma_{Z}^2(1+\theta)\lambda^2}]^n
\end{aligned}
$$
\
\
\
$$
M(\lambda)=E[e^{\lambda_1(Z_{t}+\theta Z_{t-1})}\ *\ e^{\lambda_2(Z_{t}+\theta Z_{t-1})}\ *\ ...\ *\ e^{\lambda_n(Z_{t}+\theta Z_{t-1})}]\\
$$