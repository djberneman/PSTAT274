...
X_t <- na.omit(Z_t + 2*Z_t1 - 8*Z_t2)

# Calculated autocorrelation at lag 2 is -0.1159
acf(X_t, lag=2, plot=FALSE)[2]
# Sample autocorrelation at lag 2 is very close to what was calculated.

Z_t <- rnorm(n=10000, 0,1)
...
# Calculated autocorrelation at lag 2 is -0.1159
acf(X_t, lag=2, plot=FALSE)[2]
# Either I calculated the autocorrelation at lag 2 wrong, or more observation make the sample autocorrelation worse.
```
