...
log = list()
sqrt = list()
Data_a <- data.frame(matrix(ncol=19, nrow=480))
...
Data_a_AD_Pass = subset(Data_a, Data_a$`Anderson-Darling Test` > 0.05)[, c(1:12, 18, 20)]
Data_a_AD_Pass
Data_a_Shapiro_Pass = subset(Data_a, Data_a$`Shapiro test` > 0.05)[, c(1:12, 18, 20)]
Data_a_Shapiro_Pass
Data_a_ADF_Pass = subset(Data_a, Data_a$`Augmented Dickey-Fuller Test` < 0.05)[, c(1:12, 18, 20)]
Data_a_ADF_Pass
Data_a_KPSS_Pass = subset(Data_a, Data_a$`KPSS Test` >= 0.05)[, c(1:12, 18, 20)]
Data_a_KPSS_Pass

Data_a1 = subset(Data_a, Data_a$Pass >= 4)
Tier1_a1 = subset(Data_a, Data_a$Pass >= 6)
```
