...
```{r}
options(scipen = 9)
covid <- read_excel("Covid_data_copy.xlsx")

covid <- covid[5:1363,]

covid <- covid %>%
  mutate("Deaths_after_all_vax" = covid$total_deaths - covid$total_deaths[453]) %>%
  mutate("Cases_after_all_vax" = covid$total_cases - covid$total_cases[453])

covid <- covid %>%
  mutate("Mortality_post_vax_final" = covid$Deaths_after_all_vax / covid$Cases_after_all_vax)

covid[1:453, 21:23] = NA


# Smoothed_Cases: [January 8, 2020 - September 27, 2023]
  # Daily
Smoothed_Cases1a = ts(covid$new_cases_smoothed[1:1359], frequency = 365, start = c(2020, 8))
Smoothed_Cases1a= data.frame(Smoothed_Cases1a)
  # Weekly
Smoothed_Cases1b=vector()
for(i in 1:194){
  x = 7 * (i-1) + 1
  y = 7 * i
  Smoothed_Cases1b <- append(Smoothed_Cases1b, mean(Smoothed_Cases1a[x:y, 1]))
  Smoothed_Cases1b = ts(Smoothed_Cases1b, frequency = 365/7, start = c(2020, 8/7))}
Smoothed_Cases1b = data.frame(Smoothed_Cases1b)
  # Bi-Daily
Smoothed_Cases1c=vector()
for(i in 1:679){
  x = 2 * (i-1) + 1
  y = 2 * i
  Smoothed_Cases1c <- append(Smoothed_Cases1c, mean(Smoothed_Cases1a[x:y, 1]))
  Smoothed_Cases1c = ts(Smoothed_Cases1c, frequency = 365/2, start = c(2020, 4))}
Smoothed_Cases1c = data.frame(Smoothed_Cases1c)
  # Tri-Daily
Smoothed_Cases1d=vector()
for(i in 1:453){
  x = 3 * (i-1) + 1
  y = 3 * i
  Smoothed_Cases1d <- append(Smoothed_Cases1d, mean(Smoothed_Cases1a[x:y, 1]))
  Smoothed_Cases1d = ts(Smoothed_Cases1d, frequency = 365/3, start = c(2020, 8/3))}
Smoothed_Cases1d = data.frame(Smoothed_Cases1d)
  # Quad-Daily
Smoothed_Cases1e=vector()
for(i in 1:339){
  x = 4 * (i-1) + 1
  y = 4 * i
  Smoothed_Cases1e <- append(Smoothed_Cases1e, mean(Smoothed_Cases1a[x:y, 1]))
  Smoothed_Cases1e = ts(Smoothed_Cases1e, frequency = 365/4, start = c(2020, 2))}
Smoothed_Cases1e = data.frame(Smoothed_Cases1e)
  # Penta-Daily
Smoothed_Cases1f=vector()
for(i in 1:271){
  x = 5 * (i-1) + 1
  y = 5 * i
  Smoothed_Cases1f <- append(Smoothed_Cases1f, mean(Smoothed_Cases1a[x:y, 1]))
  Smoothed_Cases1f = ts(Smoothed_Cases1f, frequency = 365/5, start = c(2020, 8/5))}
Smoothed_Cases1f = data.frame(Smoothed_Cases1f)
  # Sext-Daily
Smoothed_Cases1g=vector()
for(i in 1:226){
  x = 6 * (i-1) + 1
  y = 6 * i
  Smoothed_Cases1g <- append(Smoothed_Cases1g, mean(Smoothed_Cases1a[x:y, 1]))
  Smoothed_Cases1g = ts(Smoothed_Cases1g, frequency = 365/6, start = c(2020, 8/6))}
Smoothed_Cases1g = data.frame(Smoothed_Cases1g)



# Cases: [January 17, 2020 - September 24, 2023]
  # Daily
Cases1a = ts(covid$new_cases[10:1356], frequency = 365, start = c(2020, 17))
...
for(i in 1:192){
  ...
  Cases1b = ts(Cases1b, frequency = 365/7, start = c(2020, 17/7))}
...
for(i in 1:673){
  ...
  Cases1c = ts(Cases1c, frequency = 365/2, start = c(2020, 17/2))}
...
for(i in 1:449){
  ...
  Cases1d = ts(Cases1d, frequency = 365/3, start = c(2020, 17/3))}
...
for(i in 1:336){
  ...
  Cases1e = ts(Cases1e, frequency = 365/4, start = c(2020, 17/4))}
...
for(i in 1:269){
  ...
  Cases1f = ts(Cases1f, frequency = 365/5, start = c(2020, 17/5))}
...
for(i in 1:224){
  ...
  Cases1g = ts(Cases1g, frequency = 365/6, start = c(2020, 17/6))}
Cases1g = data.frame(Cases1g)



# Smoothed_Deaths: [January 8, 2020 - September 27, 2023]
  # Daily
Smoothed_Deaths1a = ts(covid$new_deaths_smoothed[1:1359], frequency = 365, start = c(2020, 8))
Smoothed_Deaths1a= data.frame(Smoothed_Deaths1a)
  # Weekly
Smoothed_Deaths1b=vector()
for(i in 1:194){
  x = 7 * (i-1) + 1
  y = 7 * i
  Smoothed_Deaths1b <- append(Smoothed_Deaths1b, mean(Smoothed_Deaths1a[x:y, 1]))
  Smoothed_Deaths1b = ts(Smoothed_Deaths1b, frequency = 365/7, start = c(2020, 8/7))}
Smoothed_Deaths1b = data.frame(Smoothed_Deaths1b)
  # Bi-Daily
Smoothed_Deaths1c=vector()
for(i in 1:679){
  x = 2 * (i-1) + 1
  y = 2 * i
  Smoothed_Deaths1c <- append(Smoothed_Deaths1c, mean(Smoothed_Deaths1a[x:y, 1]))
  Smoothed_Deaths1c = ts(Smoothed_Deaths1c, frequency = 365/2, start = c(2020, 4))}
Smoothed_Deaths1c = data.frame(Smoothed_Deaths1c)
  # Tri-Daily
Smoothed_Deaths1d=vector()
for(i in 1:453){
  x = 3 * (i-1) + 1
  y = 3 * i
  Smoothed_Deaths1d <- append(Smoothed_Deaths1d, mean(Smoothed_Deaths1a[x:y, 1]))
  Smoothed_Deaths1d = ts(Smoothed_Deaths1d, frequency = 365/3, start = c(2020, 8/3))}
Smoothed_Deaths1d = data.frame(Smoothed_Deaths1d)
  # Quad-Daily
Smoothed_Deaths1e=vector()
for(i in 1:339){
  x = 4 * (i-1) + 1
  y = 4 * i
  Smoothed_Deaths1e <- append(Smoothed_Deaths1e, mean(Smoothed_Deaths1a[x:y, 1]))
  Smoothed_Deaths1e = ts(Smoothed_Deaths1e, frequency = 365/4, start = c(2020, 2))}
Smoothed_Deaths1e = data.frame(Smoothed_Deaths1e)
  # Penta-Daily
Smoothed_Deaths1f=vector()
for(i in 1:271){
  x = 5 * (i-1) + 1
  y = 5 * i
  Smoothed_Deaths1f <- append(Smoothed_Deaths1f, mean(Smoothed_Deaths1a[x:y, 1]))
  Smoothed_Deaths1f = ts(Smoothed_Deaths1f, frequency = 365/5, start = c(2020, 8/5))}
Smoothed_Deaths1f = data.frame(Smoothed_Deaths1f)
  # Sext-Daily
Smoothed_Deaths1g=vector()
for(i in 1:226){
  x = 6 * (i-1) + 1
  y = 6 * i
  Smoothed_Deaths1g <- append(Smoothed_Deaths1g, mean(Smoothed_Deaths1a[x:y, 1]))
  Smoothed_Deaths1g = ts(Smoothed_Deaths1g, frequency = 365/6, start = c(2020, 8/6))}
Smoothed_Deaths1g = data.frame(Smoothed_Deaths1g)



# Deaths: [January 19, 2020 - September 20, 2023]
  # Daily
Deaths1a = ts(covid$new_deaths[12:1352])
Deaths1a= data.frame(Deaths1a, frequency = 365, start = c(2020, 19))
  # Weekly
Deaths1b=vector()
for(i in 1:191){
  x = 7 * (i-1) + 1
  ...
  Deaths1b = ts(Deaths1b, frequency = 365/7, start = c(2020, 19/7))}
...
for(i in 1:670){
  ...
  Deaths1c = ts(Deaths1c, frequency = 365/2, start = c(2020, 19/2))}
...
for(i in 1:447){
  ...
  Deaths1d = ts(Deaths1d, frequency = 365/3, start = c(2020, 19/3))}
...
for(i in 1:335){
  ...
  Deaths1e = ts(Deaths1e, frequency = 365/4, start = c(2020, 19/4))}
...
for(i in 1:268){
  ...
  Deaths1f = ts(Deaths1f, frequency = 365/5, start = c(2020, 19/5))}
...
for(i in 1:223){
  ...
  Deaths1g = ts(Deaths1g, frequency = 365/6, start = c(2020, 19/6))}
Deaths1g = data.frame(Deaths1g)


# Mortality: [January 5, 2020 - September 27, 2023]
  # Daily
Mort1a = ts(covid$Mortality[1:1359], frequency = 365, start = c(2020, 5))
...
for(i in 1:194){
  ...
  Mort1b = ts(Mort1b, frequency = 365/7, start = c(2020, 5/7))}
...
for(i in 1:679){
  ...
  Mort1c = ts(Mort1c, frequency = 365/2, start = c(2020, 5/2))}
...
for(i in 1:453){
  ...
  Mort1d = ts(Mort1d, frequency = 365/3, start = c(2020, 5/3))}
...
for(i in 1:339){
  ...
  Mort1e = ts(Mort1e, frequency = 365/4, start = c(2020, 5/4))}
...
for(i in 1:271){
  ...
  Mort1f = ts(Mort1f, frequency = 365/5, start = c(2020, 1))}
...
for(i in 1:226){
  ...
  Mort1g = ts(Mort1g, frequency = 365/6, start = c(2020, 5/6))}
Mort1g = data.frame(Mort1g)


# Smoothed_Cases: [January 8, 2020 - December 3, 2020]
  # Daily
Smoothed_Cases2a = ts(covid$new_cases_smoothed[1:331], frequency = 365, start = c(2020, 8))
Smoothed_Cases2a= data.frame(Smoothed_Cases2a)
  # Weekly
Smoothed_Cases2b=vector()
for(i in 1:47){
  x = 7 * (i-1) + 1
  y = 7 * i
  Smoothed_Cases2b <- append(Smoothed_Cases2b, mean(Smoothed_Cases2a[x:y, 1]))
  Smoothed_Cases2b = ts(Smoothed_Cases2b, frequency = 365/7, start = c(2020, 8/7))}
Smoothed_Cases2b = data.frame(Smoothed_Cases2b)
  # Bi-Daily
Smoothed_Cases2c=vector()
for(i in 1:165){
  x = 2 * (i-1) + 1
  y = 2 * i
  Smoothed_Cases2c <- append(Smoothed_Cases2c, mean(Smoothed_Cases2a[x:y, 1]))
  Smoothed_Cases2c = ts(Smoothed_Cases2c, frequency = 365/2, start = c(2020, 4))}
Smoothed_Cases2c = data.frame(Smoothed_Cases2c)
  # Tri-Daily
Smoothed_Cases2d=vector()
for(i in 1:110){
  x = 3 * (i-1) + 1
  y = 3 * i
  Smoothed_Cases2d <- append(Smoothed_Cases2d, mean(Smoothed_Cases2a[x:y, 1]))
  Smoothed_Cases2d = ts(Smoothed_Cases2d, frequency = 365/3, start = c(2020, 8/3))}
Smoothed_Cases2d = data.frame(Smoothed_Cases2d)
  # Quad-Daily
Smoothed_Cases2e=vector()
for(i in 1:82){
  x = 4 * (i-1) + 1
  y = 4 * i
  Smoothed_Cases2e <- append(Smoothed_Cases2e, mean(Smoothed_Cases2a[x:y, 1]))
  Smoothed_Cases2e = ts(Smoothed_Cases2e, frequency = 365/4, start = c(2020, 2))}
Smoothed_Cases2e = data.frame(Smoothed_Cases2e)
  # Penta-Daily
Smoothed_Cases2f=vector()
for(i in 1:66){
  x = 5 * (i-1) + 1
  y = 5 * i
  Smoothed_Cases2f <- append(Smoothed_Cases2f, mean(Smoothed_Cases2a[x:y, 1]))
  Smoothed_Cases2f = ts(Smoothed_Cases2f, frequency = 365/5, start = c(2020, 8/5))}
Smoothed_Cases2f = data.frame(Smoothed_Cases2f)
  # Sext-Daily
Smoothed_Cases2g=vector()
for(i in 1:55){
  x = 6 * (i-1) + 1
  y = 6 * i
  Smoothed_Cases2g <- append(Smoothed_Cases2g, mean(Smoothed_Cases2a[x:y, 1]))
  Smoothed_Cases2g = ts(Smoothed_Cases2g, frequency = 365/6, start = c(2020, 8/6))}
Smoothed_Cases2g = data.frame(Smoothed_Cases2g)


# Cases: [January 17, 2020 - December 3, 2020]
  # Daily
Cases2a = ts(covid$new_cases[10:331])
Cases2a= data.frame(Cases2a, frequency = 365, start = c(2020, 17))
  # Weekly
Cases2b=vector()
for(i in 1:46){
  x = 7 * (i-1) + 1
  ...
  Cases2b = ts(Cases2b, frequency = 365/7, start = c(2020, 17/7))}
...
for(i in 1:161){
  ...
  Cases2c = ts(Cases2c, frequency = 365/2, start = c(2020, 17/2))}
...
for(i in 1:107){
  ...
  Cases2d = ts(Cases2d, frequency = 365/3, start = c(2020, 17/3))}
...
for(i in 1:80){
  ...
  Cases2e = ts(Cases2e, frequency = 365/4, start = c(2020, 17/4))}
...
for(i in 1:64){
  ...
  Cases2f = ts(Cases2f, frequency = 365/5, start = c(2020, 17/5))}
...
for(i in 1:53){
  x = 6 * (i-1) + 1
  y = 6 * i
  Cases2g <- append(Cases2g, mean(Cases2a[x:y, 1]))
  Cases2g = ts(Cases2g, frequency = 365/6, start = c(2020, 17/6))}
Cases2g = data.frame(Cases2g)


# Smoothed_Deaths: [January 8, 2020 - December 3, 2020]
  # Daily
Smoothed_Deaths2a = ts(covid$new_deaths_smoothed[1:331], frequency = 365, start = c(2020, 8))
Smoothed_Deaths2a= data.frame(Smoothed_Deaths2a)
  # Weekly
Smoothed_Deaths2b=vector()
for(i in 1:47){
  x = 7 * (i-1) + 1
  y = 7 * i
  Smoothed_Deaths2b <- append(Smoothed_Deaths2b, mean(Smoothed_Deaths2a[x:y, 1]))
  Smoothed_Deaths2b = ts(Smoothed_Deaths2b, frequency = 365/7, start = c(2020, 8/7))}
Smoothed_Deaths2b = data.frame(Smoothed_Deaths2b)
  # Bi-Daily
Smoothed_Deaths2c=vector()
for(i in 1:165){
  x = 2 * (i-1) + 1
  y = 2 * i
  Smoothed_Deaths2c <- append(Smoothed_Deaths2c, mean(Smoothed_Deaths2a[x:y, 1]))
  Smoothed_Deaths2c = ts(Smoothed_Deaths2c, frequency = 365/2, start = c(2020, 8/2))}
Smoothed_Deaths2c = data.frame(Smoothed_Deaths2c)
  # Tri-Daily
Smoothed_Deaths2d=vector()
for(i in 1:110){
  x = 3 * (i-1) + 1
  y = 3 * i
  Smoothed_Deaths2d <- append(Smoothed_Deaths2d, mean(Smoothed_Deaths2a[x:y, 1]))
  Smoothed_Deaths2d = ts(Smoothed_Deaths2d, frequency = 365/3, start = c(2020, 8/3))}
Smoothed_Deaths2d = data.frame(Smoothed_Deaths2d)
  # Quad-Daily
Smoothed_Deaths2e=vector()
for(i in 1:82){
  x = 4 * (i-1) + 1
  y = 4 * i
  Smoothed_Deaths2e <- append(Smoothed_Deaths2e, mean(Smoothed_Deaths2a[x:y, 1]))
  Smoothed_Deaths2e = ts(Smoothed_Deaths2e, frequency = 365/4, start = c(2020, 8/4))}
Smoothed_Deaths2e = data.frame(Smoothed_Deaths2e)
  # Penta-Daily
Smoothed_Deaths2f=vector()
for(i in 1:66){
  x = 5 * (i-1) + 1
  y = 5 * i
  Smoothed_Deaths2f <- append(Smoothed_Deaths2f, mean(Smoothed_Deaths2a[x:y, 1]))
  Smoothed_Deaths2f = ts(Smoothed_Deaths2f, frequency = 365/5, start = c(2020, 8/5))}
Smoothed_Deaths2f = data.frame(Smoothed_Deaths2f)
  # Sext-Daily
Smoothed_Deaths2g=vector()
for(i in 1:55){
  x = 6 * (i-1) + 1
  y = 6 * i
  Smoothed_Deaths2g <- append(Smoothed_Deaths2g, mean(Smoothed_Deaths2a[x:y, 1]))
  Smoothed_Deaths2g = ts(Smoothed_Deaths2g, frequency = 365/6, start = c(2020, 8/6))}
Smoothed_Deaths2g = data.frame(Smoothed_Deaths2g)



# Deaths: [January 19, 2020 - December 3, 2020]
  # Daily
Deaths2a = ts(covid$new_deaths_smoothed[12:331], frequency = 365, start = c(2020, 19))
...
for(i in 1:45){
  ...
  Deaths2b = ts(Deaths2b, frequency = 365/7, start = c(2020, 19/7))}
...
for(i in 1:160){
  ...
  Deaths2c = ts(Deaths2c, frequency = 365/2, start = c(2020, 19/2))}
...
for(i in 1:106){
  ...
  Deaths2d = ts(Deaths2d, frequency = 365/3, start = c(2020, 19/3))}
...
for(i in 1:80){
  ...
  Deaths2e = ts(Deaths2e, frequency = 365/4, start = c(2020, 19/4))}
...
for(i in 1:64){
  ...
  Deaths2f = ts(Deaths2f, frequency = 365/5, start = c(2020, 19/5))}
...
for(i in 1:53){
  x = 6 * (i-1) + 1
  y = 6 * i
  Deaths2g <- append(Deaths2g, mean(Deaths2a[x:y, 1]))
  Deaths2g = ts(Deaths2g, frequency = 365/6, start = c(2020, 19/6))}
Deaths2g = data.frame(Deaths2g)


# Mortality: [January 8, 2020 - December 3, 2020]
  # Daily
Mort2a = ts(covid$Mortality[1:331])
...
for(i in 1:55){
  x = 6 * (i-1) + 1
  y = 6 * i
  Mort2g <- append(Mort2g, mean(Mort2a[x:y, 1]))
  Mort2g = ts(Mort2g)}
Mort2g = data.frame(Mort2g)


# Smoothed_Cases: [January 8, 2020 - April 4, 2021]
  # Daily
Smoothed_Cases2_5a = ts(covid$new_cases_smoothed[1:453])
Smoothed_Cases2_5a= data.frame(Smoothed_Cases2_5a)
  # Weekly
Smoothed_Cases2_5b=vector()
for(i in 1:64){
  x = 7 * (i-1) + 1
  y = 7 * i
  Smoothed_Cases2_5b <- append(Smoothed_Cases2_5b, mean(Smoothed_Cases2_5a[x:y, 1]))
  Smoothed_Cases2_5b = ts(Smoothed_Cases2_5b)}
Smoothed_Cases2_5b = data.frame(Smoothed_Cases2_5b)
  # Bi-Daily
Smoothed_Cases2_5c=vector()
for(i in 1:226){
  x = 2 * (i-1) + 1
  y = 2 * i
  Smoothed_Cases2_5c <- append(Smoothed_Cases2_5c, mean(Smoothed_Cases2_5a[x:y, 1]))
  Smoothed_Cases2_5c = ts(Smoothed_Cases2_5c)}
Smoothed_Cases2_5c = data.frame(Smoothed_Cases2_5c)
  # Tri-Daily
Smoothed_Cases2_5d=vector()
for(i in 1:151){
  x = 3 * (i-1) + 1
  y = 3 * i
  Smoothed_Cases2_5d <- append(Smoothed_Cases2_5d, mean(Smoothed_Cases2_5a[x:y, 1]))
  Smoothed_Cases2_5d = ts(Smoothed_Cases2_5d)}
Smoothed_Cases2_5d = data.frame(Smoothed_Cases2_5d)
  # Quad-Daily
Smoothed_Cases2_5e=vector()
for(i in 1:113){
  x = 4 * (i-1) + 1
  y = 4 * i
  Smoothed_Cases2_5e <- append(Smoothed_Cases2_5e, mean(Smoothed_Cases2_5a[x:y, 1]))
  Smoothed_Cases2_5e = ts(Smoothed_Cases2_5e)}
Smoothed_Cases2_5e = data.frame(Smoothed_Cases2_5e)
  # Penta-Daily
Smoothed_Cases2_5f=vector()
for(i in 1:90){
  x = 5 * (i-1) + 1
  y = 5 * i
  Smoothed_Cases2_5f <- append(Smoothed_Cases2_5f, mean(Smoothed_Cases2_5a[x:y, 1]))
  Smoothed_Cases2_5f = ts(Smoothed_Cases2_5f)}
Smoothed_Cases2_5f = data.frame(Smoothed_Cases2_5f)
  # Sext-Daily
Smoothed_Cases2_5g=vector()
for(i in 1:75){
  x = 6 * (i-1) + 1
  y = 6 * i
  Smoothed_Cases2_5g <- append(Smoothed_Cases2_5g, mean(Smoothed_Cases2_5a[x:y, 1]))
  Smoothed_Cases2_5g = ts(Smoothed_Cases2_5g)}
Smoothed_Cases2_5g = data.frame(Smoothed_Cases2_5g)



# Cases: [January 17, 2020 - April 4, 2021]
  # Daily
Cases2_5a = ts(covid$new_cases[10:453])
...
# Smoothed_Deaths: [January 8, 2020 - April 4, 2021]
  # Daily
Smoothed_Deaths2_5a = ts(covid$new_deaths_smoothed[1:453])
Smoothed_Deaths2_5a= data.frame(Smoothed_Deaths2_5a)
  # Weekly
Smoothed_Deaths2_5b=vector()
for(i in 1:64){
  x = 7 * (i-1) + 1
  y = 7 * i
  Smoothed_Deaths2_5b <- append(Smoothed_Deaths2_5b, mean(Smoothed_Deaths2_5a[x:y, 1]))
  Smoothed_Deaths2_5b = ts(Smoothed_Deaths2_5b)}
Smoothed_Deaths2_5b = data.frame(Smoothed_Deaths2_5b)
  # Bi-Daily
Smoothed_Deaths2_5c=vector()
for(i in 1:226){
  x = 2 * (i-1) + 1
  y = 2 * i
  Smoothed_Deaths2_5c <- append(Smoothed_Deaths2_5c, mean(Smoothed_Deaths2_5a[x:y, 1]))
  Smoothed_Deaths2_5c = ts(Smoothed_Deaths2_5c)}
Smoothed_Deaths2_5c = data.frame(Smoothed_Deaths2_5c)
  # Tri-Daily
Smoothed_Deaths2_5d=vector()
for(i in 1:151){
  x = 3 * (i-1) + 1
  y = 3 * i
  Smoothed_Deaths2_5d <- append(Smoothed_Deaths2_5d, mean(Smoothed_Deaths2_5a[x:y, 1]))
  Smoothed_Deaths2_5d = ts(Smoothed_Deaths2_5d)}
Smoothed_Deaths2_5d = data.frame(Smoothed_Deaths2_5d)
  # Quad-Daily
Smoothed_Deaths2_5e=vector()
for(i in 1:113){
  x = 4 * (i-1) + 1
  y = 4 * i
  Smoothed_Deaths2_5e <- append(Smoothed_Deaths2_5e, mean(Smoothed_Deaths2_5a[x:y, 1]))
  Smoothed_Deaths2_5e = ts(Smoothed_Deaths2_5e)}
Smoothed_Deaths2_5e = data.frame(Smoothed_Deaths2_5e)
  # Penta-Daily
Smoothed_Deaths2_5f=vector()
for(i in 1:90){
  x = 5 * (i-1) + 1
  y = 5 * i
  Smoothed_Deaths2_5f <- append(Smoothed_Deaths2_5f, mean(Smoothed_Deaths2_5a[x:y, 1]))
  Smoothed_Deaths2_5f = ts(Smoothed_Deaths2_5f)}
Smoothed_Deaths2_5f = data.frame(Smoothed_Deaths2_5f)
  # Sext-Daily
Smoothed_Deaths2_5g=vector()
for(i in 1:75){
  x = 6 * (i-1) + 1
  y = 6 * i
  Smoothed_Deaths2_5g <- append(Smoothed_Deaths2_5g, mean(Smoothed_Deaths2_5a[x:y, 1]))
  Smoothed_Deaths2_5g = ts(Smoothed_Deaths2_5g)}
Smoothed_Deaths2_5g = data.frame(Smoothed_Deaths2_5g)



# Deaths: [January 19, 2020 - April 4, 2021]
  # Daily
Deaths2_5a = ts(covid$new_deaths[12:453])
...
# Mortality: [January 8, 2020 - April 4, 2021]
  # Daily
Mort2_5a = ts(covid$Mortality[1:453])
...
# Smoothed_Cases: [December 4, 2020 - September 27, 2023]
  # Daily
Smoothed_Cases3a = ts(covid$new_cases_smoothed[332:1359])
Smoothed_Cases3a= data.frame(Smoothed_Cases3a)
  # Weekly
Smoothed_Cases3b=vector()
for(i in 1:146){
  x = 7 * (i-1) + 1
  y = 7 * i
  Smoothed_Cases3b <- append(Smoothed_Cases3b, mean(Smoothed_Cases3a[x:y, 1]))
  Smoothed_Cases3b = ts(Smoothed_Cases3b)}
Smoothed_Cases3b = data.frame(Smoothed_Cases3b)
  # Bi-Daily
Smoothed_Cases3c=vector()
for(i in 1:514){
  x = 2 * (i-1) + 1
  y = 2 * i
  Smoothed_Cases3c <- append(Smoothed_Cases3c, mean(Smoothed_Cases3a[x:y, 1]))
  Smoothed_Cases3c = ts(Smoothed_Cases3c)}
Smoothed_Cases3c = data.frame(Smoothed_Cases3c)
  # Tri-Daily
Smoothed_Cases3d=vector()
for(i in 1:342){
  x = 3 * (i-1) + 1
  y = 3 * i
  Smoothed_Cases3d <- append(Smoothed_Cases3d, mean(Smoothed_Cases3a[x:y, 1]))
  Smoothed_Cases3d = ts(Smoothed_Cases3d)}
Smoothed_Cases3d = data.frame(Smoothed_Cases3d)
  # Quad-Daily
Smoothed_Cases3e=vector()
for(i in 1:257){
  x = 4 * (i-1) + 1
  y = 4 * i
  Smoothed_Cases3e <- append(Smoothed_Cases3e, mean(Smoothed_Cases3a[x:y, 1]))
  Smoothed_Cases3e = ts(Smoothed_Cases3e)}
Smoothed_Cases3e = data.frame(Smoothed_Cases3e)
  # Penta-Daily
Smoothed_Cases3f=vector()
for(i in 1:205){
  x = 5 * (i-1) + 1
  y = 5 * i
  Smoothed_Cases3f <- append(Smoothed_Cases3f, mean(Smoothed_Cases3a[x:y, 1]))
  Smoothed_Cases3f = ts(Smoothed_Cases3f)}
Smoothed_Cases3f = data.frame(Smoothed_Cases3f)
  # Sext-Daily
Smoothed_Cases3g=vector()
for(i in 1:171){
  x = 6 * (i-1) + 1
  y = 6 * i
  Smoothed_Cases3g <- append(Smoothed_Cases3g, mean(Smoothed_Cases3a[x:y, 1]))
  Smoothed_Cases3g = ts(Smoothed_Cases3g)}
Smoothed_Cases3g = data.frame(Smoothed_Cases3g)



# Cases: [December 4, 2020 - September 24, 2023]
  # Daily
Cases3a = ts(covid$new_cases[332:1356])
...
# Smoothed_Deaths: [December 4, 2020 - September 27, 2023]
  # Daily
Smoothed_Deaths3a = ts(covid$new_deaths_smoothed[332:1359])
Smoothed_Deaths3a= data.frame(Smoothed_Deaths3a)
  # Weekly
Smoothed_Deaths3b=vector()
for(i in 1:146){
  x = 7 * (i-1) + 1
  y = 7 * i
  Smoothed_Deaths3b <- append(Smoothed_Deaths3b, mean(Smoothed_Deaths3a[x:y, 1]))
  Smoothed_Deaths3b = ts(Smoothed_Deaths3b)}
Smoothed_Deaths3b = data.frame(Smoothed_Deaths3b)
  # Bi-Daily
Smoothed_Deaths3c=vector()
for(i in 1:514){
  x = 2 * (i-1) + 1
  y = 2 * i
  Smoothed_Deaths3c <- append(Smoothed_Deaths3c, mean(Smoothed_Deaths3a[x:y, 1]))
  Smoothed_Deaths3c = ts(Smoothed_Deaths3c)}
Smoothed_Deaths3c = data.frame(Smoothed_Deaths3c)
  # Tri-Daily
Smoothed_Deaths3d=vector()
for(i in 1:342){
  x = 3 * (i-1) + 1
  y = 3 * i
  Smoothed_Deaths3d <- append(Smoothed_Deaths3d, mean(Smoothed_Deaths3a[x:y, 1]))
  Smoothed_Deaths3d = ts(Smoothed_Deaths3d)}
Smoothed_Deaths3d = data.frame(Smoothed_Deaths3d)
  # Quad-Daily
Smoothed_Deaths3e=vector()
for(i in 1:257){
  x = 4 * (i-1) + 1
  y = 4 * i
  Smoothed_Deaths3e <- append(Smoothed_Deaths3e, mean(Smoothed_Deaths3a[x:y, 1]))
  Smoothed_Deaths3e = ts(Smoothed_Deaths3e)}
Smoothed_Deaths3e = data.frame(Smoothed_Deaths3e)
  # Penta-Daily
Smoothed_Deaths3f=vector()
for(i in 1:205){
  x = 5 * (i-1) + 1
  y = 5 * i
  Smoothed_Deaths3f <- append(Smoothed_Deaths3f, mean(Smoothed_Deaths3a[x:y, 1]))
  Smoothed_Deaths3f = ts(Smoothed_Deaths3f)}
Smoothed_Deaths3f = data.frame(Smoothed_Deaths3f)
  # Sext-Daily
Smoothed_Deaths3g=vector()
for(i in 1:171){
  x = 6 * (i-1) + 1
  y = 6 * i
  Smoothed_Deaths3g <- append(Smoothed_Deaths3g, mean(Smoothed_Deaths3a[x:y, 1]))
  Smoothed_Deaths3g = ts(Smoothed_Deaths3g)}
Smoothed_Deaths3g = data.frame(Smoothed_Deaths3g)



# Deaths: [December 4, 2020 - September 27, 2023]
  # Daily
Deaths3a = ts(covid$new_deaths[332:1352])
...
# Mortality: [December 4, 2020 - September 27, 2023]
  # Daily
Mort3a = ts(covid$Mortality_post_vax[332:1359])
...
# Vax1_rate: [December 4, 2020 - September 27, 2023]
  # Daily
Vax1_rate_3a = ts(covid$Vax_rate1[332:1359])
Vax1_rate_3a= data.frame(Vax1_rate_3a)
  # Weekly
Vax1_rate_3b=vector()
for(i in 1:146){
  x = 7 * (i-1) + 1
  y = 7 * i
  Vax1_rate_3b <- append(Vax1_rate_3b, mean(Vax1_rate_3a[x:y, 1]))
  Vax1_rate_3b = ts(Vax1_rate_3b)}
Vax1_rate_3b = data.frame(Vax1_rate_3b)
  # Bi-Daily
Vax1_rate_3c=vector()
for(i in 1:514){
  x = 2 * (i-1) + 1
  y = 2 * i
  Vax1_rate_3c <- append(Vax1_rate_3c, mean(Vax1_rate_3a[x:y, 1]))
  Vax1_rate_3c = ts(Vax1_rate_3c)}
Vax1_rate_3c = data.frame(Vax1_rate_3c)
  # Tri-Daily
Vax1_rate_3d=vector()
for(i in 1:342){
  x = 3 * (i-1) + 1
  y = 3 * i
  Vax1_rate_3d <- append(Vax1_rate_3d, mean(Vax1_rate_3a[x:y, 1]))
  Vax1_rate_3d = ts(Vax1_rate_3d)}
Vax1_rate_3d = data.frame(Vax1_rate_3d)
  # Quad-Daily
Vax1_rate_3e=vector()
for(i in 1:257){
  x = 4 * (i-1) + 1
  y = 4 * i
  Vax1_rate_3e <- append(Vax1_rate_3e, mean(Vax1_rate_3a[x:y, 1]))
  Vax1_rate_3e = ts(Vax1_rate_3e)}
Vax1_rate_3e = data.frame(Vax1_rate_3e)
  # Penta-Daily
Vax1_rate_3f=vector()
for(i in 1:205){
  x = 5 * (i-1) + 1
  y = 5 * i
  Vax1_rate_3f <- append(Vax1_rate_3f, mean(Vax1_rate_3a[x:y, 1]))
  Vax1_rate_3f = ts(Vax1_rate_3f)}
Vax1_rate_3f = data.frame(Vax1_rate_3f)
  # Sext-Daily
Vax1_rate_3g=vector()
for(i in 1:171){
  x = 6 * (i-1) + 1
  y = 6 * i
  Vax1_rate_3g <- append(Vax1_rate_3g, mean(Vax1_rate_3a[x:y, 1]))
  Vax1_rate_3g = ts(Vax1_rate_3g)}
Vax1_rate_3g = data.frame(Vax1_rate_3g)



# Vax2_rate: [December 4, 2020 - September 27, 2023]
  # Daily
Vax2_rate_3a = ts(covid$Vax_rate2[332:1359])
Vax2_rate_3a= data.frame(Vax2_rate_3a)
  # Weekly
Vax2_rate_3b=vector()
for(i in 1:146){
  x = 7 * (i-1) + 1
  y = 7 * i
  Vax2_rate_3b <- append(Vax2_rate_3b, mean(Vax2_rate_3a[x:y, 1]))
  Vax2_rate_3b = ts(Vax2_rate_3b)}
Vax2_rate_3b = data.frame(Vax2_rate_3b)
  # Bi-Daily
Vax2_rate_3c=vector()
for(i in 1:514){
  x = 2 * (i-1) + 1
  y = 2 * i
  Vax2_rate_3c <- append(Vax2_rate_3c, mean(Vax2_rate_3a[x:y, 1]))
  Vax2_rate_3c = ts(Vax2_rate_3c)}
Vax2_rate_3c = data.frame(Vax2_rate_3c)
  # Tri-Daily
Vax2_rate_3d=vector()
for(i in 1:342){
  x = 3 * (i-1) + 1
  y = 3 * i
  Vax2_rate_3d <- append(Vax2_rate_3d, mean(Vax2_rate_3a[x:y, 1]))
  Vax2_rate_3d = ts(Vax2_rate_3d)}
Vax2_rate_3d = data.frame(Vax2_rate_3d)
  # Quad-Daily
Vax2_rate_3e=vector()
for(i in 1:257){
  x = 4 * (i-1) + 1
  y = 4 * i
  Vax2_rate_3e <- append(Vax2_rate_3e, mean(Vax2_rate_3a[x:y, 1]))
  Vax2_rate_3e = ts(Vax2_rate_3e)}
Vax2_rate_3e = data.frame(Vax2_rate_3e)
  # Penta-Daily
Vax2_rate_3f=vector()
for(i in 1:205){
  x = 5 * (i-1) + 1
  y = 5 * i
  Vax2_rate_3f <- append(Vax2_rate_3f, mean(Vax2_rate_3a[x:y, 1]))
  Vax2_rate_3f = ts(Vax2_rate_3f)}
Vax2_rate_3f = data.frame(Vax2_rate_3f)
  # Sext-Daily
Vax2_rate_3g=vector()
for(i in 1:171){
  x = 6 * (i-1) + 1
  y = 6 * i
  Vax2_rate_3g <- append(Vax2_rate_3g, mean(Vax2_rate_3a[x:y, 1]))
  Vax2_rate_3g = ts(Vax2_rate_3g)}
Vax2_rate_3g = data.frame(Vax2_rate_3g)


# Full_Vax1_rate: [December 13, 2020 - September 27, 2023]
  # Daily
Full_Vax1_rate_3a = ts(covid$Full_Vax_rate1[341:1359])
Full_Vax1_rate_3a= data.frame(Full_Vax1_rate_3a)
  # Weekly
Full_Vax1_rate_3b=vector()
for(i in 1:145){
  x = 7 * (i-1) + 1
  y = 7 * i
  Full_Vax1_rate_3b <- append(Full_Vax1_rate_3b, mean(Full_Vax1_rate_3a[x:y, 1]))
  Full_Vax1_rate_3b = ts(Full_Vax1_rate_3b)}
Full_Vax1_rate_3b = data.frame(Full_Vax1_rate_3b)
  # Bi-Daily
Full_Vax1_rate_3c=vector()
for(i in 1:509){
  x = 2 * (i-1) + 1
  y = 2 * i
  Full_Vax1_rate_3c <- append(Full_Vax1_rate_3c, mean(Full_Vax1_rate_3a[x:y, 1]))
  Full_Vax1_rate_3c = ts(Full_Vax1_rate_3c)}
Full_Vax1_rate_3c = data.frame(Full_Vax1_rate_3c)
  # Tri-Daily
Full_Vax1_rate_3d=vector()
for(i in 1:339){
  x = 3 * (i-1) + 1
  y = 3 * i
  Full_Vax1_rate_3d <- append(Full_Vax1_rate_3d, mean(Full_Vax1_rate_3a[x:y, 1]))
  Full_Vax1_rate_3d = ts(Full_Vax1_rate_3d)}
Full_Vax1_rate_3d = data.frame(Full_Vax1_rate_3d)
  # Quad-Daily
Full_Vax1_rate_3e=vector()
for(i in 1:254){
  x = 4 * (i-1) + 1
  y = 4 * i
  Full_Vax1_rate_3e <- append(Full_Vax1_rate_3e, mean(Full_Vax1_rate_3a[x:y, 1]))
  Full_Vax1_rate_3e = ts(Full_Vax1_rate_3e)}
Full_Vax1_rate_3e = data.frame(Full_Vax1_rate_3e)
  # Penta-Daily
Full_Vax1_rate_3f=vector()
for(i in 1:203){
  x = 5 * (i-1) + 1
  y = 5 * i
  Full_Vax1_rate_3f <- append(Full_Vax1_rate_3f, mean(Full_Vax1_rate_3a[x:y, 1]))
  Full_Vax1_rate_3f = ts(Full_Vax1_rate_3f)}
Full_Vax1_rate_3f = data.frame(Full_Vax1_rate_3f)
  # Sext-Daily
Full_Vax1_rate_3g=vector()
for(i in 1:169){
  x = 6 * (i-1) + 1
  y = 6 * i
  Full_Vax1_rate_3g <- append(Full_Vax1_rate_3g, mean(Full_Vax1_rate_3a[x:y, 1]))
  Full_Vax1_rate_3g = ts(Full_Vax1_rate_3g)}
Full_Vax1_rate_3g = data.frame(Full_Vax1_rate_3g)


# Full_Vax2_rate: [December 13, 2020 - September 27, 2023]
  # Daily
Full_Vax2_rate_3a = ts(covid$Full_Vax_rate2[341:1359])
Full_Vax2_rate_3a= data.frame(Full_Vax2_rate_3a)
  # Weekly
Full_Vax2_rate_3b=vector()
for(i in 1:145){
  x = 7 * (i-1) + 1
  y = 7 * i
  Full_Vax2_rate_3b <- append(Full_Vax2_rate_3b, mean(Full_Vax2_rate_3a[x:y, 1]))
  Full_Vax2_rate_3b = ts(Full_Vax2_rate_3b)}
Full_Vax2_rate_3b = data.frame(Full_Vax2_rate_3b)
  # Bi-Daily
Full_Vax2_rate_3c=vector()
for(i in 1:509){
  x = 2 * (i-1) + 1
  y = 2 * i
  Full_Vax2_rate_3c <- append(Full_Vax2_rate_3c, mean(Full_Vax2_rate_3a[x:y, 1]))
  Full_Vax2_rate_3c = ts(Full_Vax2_rate_3c)}
Full_Vax2_rate_3c = data.frame(Full_Vax2_rate_3c)
  # Tri-Daily
Full_Vax2_rate_3d=vector()
for(i in 1:339){
  x = 3 * (i-1) + 1
  y = 3 * i
  Full_Vax2_rate_3d <- append(Full_Vax2_rate_3d, mean(Full_Vax2_rate_3a[x:y, 1]))
  Full_Vax2_rate_3d = ts(Full_Vax2_rate_3d)}
Full_Vax2_rate_3d = data.frame(Full_Vax2_rate_3d)
  # Quad-Daily
Full_Vax2_rate_3e=vector()
for(i in 1:254){
  x = 4 * (i-1) + 1
  y = 4 * i
  Full_Vax2_rate_3e <- append(Full_Vax2_rate_3e, mean(Full_Vax2_rate_3a[x:y, 1]))
  Full_Vax2_rate_3e = ts(Full_Vax2_rate_3e)}
Full_Vax2_rate_3e = data.frame(Full_Vax2_rate_3e)
  # Penta-Daily
Full_Vax2_rate_3f=vector()
for(i in 1:203){
  x = 5 * (i-1) + 1
  y = 5 * i
  Full_Vax2_rate_3f <- append(Full_Vax2_rate_3f, mean(Full_Vax2_rate_3a[x:y, 1]))
  Full_Vax2_rate_3f = ts(Full_Vax2_rate_3f)}
Full_Vax2_rate_3f = data.frame(Full_Vax2_rate_3f)
  # Sext-Daily
Full_Vax2_rate_3g=vector()
for(i in 1:169){
  x = 6 * (i-1) + 1
  y = 6 * i
  Full_Vax2_rate_3g <- append(Full_Vax2_rate_3g, mean(Full_Vax2_rate_3a[x:y, 1]))
  Full_Vax2_rate_3g = ts(Full_Vax2_rate_3g)}
Full_Vax2_rate_3g = data.frame(Full_Vax2_rate_3g)


# Smoothed_Cases: [April 5, 2021 - September 27, 2023]
  # Daily
Smoothed_Cases3_5a = ts(covid$new_cases_smoothed[454:1359])
Smoothed_Cases3_5a= data.frame(Smoothed_Cases3_5a)
  # Weekly
Smoothed_Cases3_5b=vector()
for(i in 1:129){
  x = 7 * (i-1) + 1
  y = 7 * i
  Smoothed_Cases3_5b <- append(Smoothed_Cases3_5b, mean(Smoothed_Cases3_5a[x:y, 1]))
  Smoothed_Cases3_5b = ts(Smoothed_Cases3_5b)}
Smoothed_Cases3_5b = data.frame(Smoothed_Cases3_5b)
  # Bi-Daily
Smoothed_Cases3_5c=vector()
for(i in 1:453){
  x = 2 * (i-1) + 1
  y = 2 * i
  Smoothed_Cases3_5c <- append(Smoothed_Cases3_5c, mean(Smoothed_Cases3_5a[x:y, 1]))
  Smoothed_Cases3_5c = ts(Smoothed_Cases3_5c)}
Smoothed_Cases3_5c = data.frame(Smoothed_Cases3_5c)
  # Tri-Daily
Smoothed_Cases3_5d=vector()
for(i in 1:302){
  x = 3 * (i-1) + 1
  y = 3 * i
  Smoothed_Cases3_5d <- append(Smoothed_Cases3_5d, mean(Smoothed_Cases3_5a[x:y, 1]))
  Smoothed_Cases3_5d = ts(Smoothed_Cases3_5d)}
Smoothed_Cases3_5d = data.frame(Smoothed_Cases3_5d)
  # Quad-Daily
Smoothed_Cases3_5e=vector()
for(i in 1:226){
  x = 4 * (i-1) + 1
  y = 4 * i
  Smoothed_Cases3_5e <- append(Smoothed_Cases3_5e, mean(Smoothed_Cases3_5a[x:y, 1]))
  Smoothed_Cases3_5e = ts(Smoothed_Cases3_5e)}
Smoothed_Cases3_5e = data.frame(Smoothed_Cases3_5e)
  # Penta-Daily
Smoothed_Cases3_5f=vector()
for(i in 1:181){
  x = 5 * (i-1) + 1
  y = 5 * i
  Smoothed_Cases3_5f <- append(Smoothed_Cases3_5f, mean(Smoothed_Cases3_5a[x:y, 1]))
  Smoothed_Cases3_5f = ts(Smoothed_Cases3_5f)}
Smoothed_Cases3_5f = data.frame(Smoothed_Cases3_5f)
  # Sext-Daily
Smoothed_Cases3_5g=vector()
for(i in 1:151){
  x = 6 * (i-1) + 1
  y = 6 * i
  Smoothed_Cases3_5g <- append(Smoothed_Cases3_5g, mean(Smoothed_Cases3_5a[x:y, 1]))
  Smoothed_Cases3_5g = ts(Smoothed_Cases3_5g)}
Smoothed_Cases3_5g = data.frame(Smoothed_Cases3_5g)


# Cases: [April 5, 2021 - September 24, 2023]
  # Daily
Cases3_5a = ts(covid$new_cases[454:1356])
Cases3_5a= data.frame(Cases3_5a)
  # Weekly
Cases3_5b=vector()
for(i in 1:129){
  x = 7 * (i-1) + 1
  y = 7 * i
  Cases3_5b <- append(Cases3_5b, mean(Cases3_5a[x:y, 1]))
  Cases3_5b = ts(Cases3_5b)}
Cases3_5b = data.frame(Cases3_5b)
  # Bi-Daily
Cases3_5c=vector()
for(i in 1:451){
  x = 2 * (i-1) + 1
  y = 2 * i
  Cases3_5c <- append(Cases3_5c, mean(Cases3_5a[x:y, 1]))
  Cases3_5c = ts(Cases3_5c)}
Cases3_5c = data.frame(Cases3_5c)
  # Tri-Daily
Cases3_5d=vector()
for(i in 1:301){
  x = 3 * (i-1) + 1
  y = 3 * i
  Cases3_5d <- append(Cases3_5d, mean(Cases3_5a[x:y, 1]))
  Cases3_5d = ts(Cases3_5d)}
Cases3_5d = data.frame(Cases3_5d)
  # Quad-Daily
Cases3_5e=vector()
for(i in 1:225){
  x = 4 * (i-1) + 1
  y = 4 * i
  Cases3_5e <- append(Cases3_5e, mean(Cases3_5a[x:y, 1]))
  Cases3_5e = ts(Cases3_5e)}
Cases3_5e = data.frame(Cases3_5e)
  # Penta-Daily
Cases3_5f=vector()
for(i in 1:180){
  x = 5 * (i-1) + 1
  y = 5 * i
  Cases3_5f <- append(Cases3_5f, mean(Cases3_5a[x:y, 1]))
  Cases3_5f = ts(Cases3_5f)}
Cases3_5f = data.frame(Cases3_5f)
  # Sext-Daily
Cases3_5g=vector()
for(i in 1:150){
  x = 6 * (i-1) + 1
  y = 6 * i
  Cases3_5g <- append(Cases3_5g, mean(Cases3_5a[x:y, 1]))
  Cases3_5g = ts(Cases3_5g)}
Cases3_5g = data.frame(Cases3_5g)


# Smoothed_Deaths: [April 5, 2021 - September 27, 2023]
  # Daily
Smoothed_Deaths3_5a = ts(covid$new_deaths_smoothed[454:1359])
Smoothed_Deaths3_5a= data.frame(Smoothed_Deaths3_5a)
  # Weekly
Smoothed_Deaths3_5b=vector()
for(i in 1:129){
  x = 7 * (i-1) + 1
  y = 7 * i
  Smoothed_Deaths3_5b <- append(Smoothed_Deaths3_5b, mean(Smoothed_Deaths3_5a[x:y, 1]))
  Smoothed_Deaths3_5b = ts(Smoothed_Deaths3_5b)}
Smoothed_Deaths3_5b = data.frame(Smoothed_Deaths3_5b)
  # Bi-Daily
Smoothed_Deaths3_5c=vector()
for(i in 1:453){
  x = 2 * (i-1) + 1
  y = 2 * i
  Smoothed_Deaths3_5c <- append(Smoothed_Deaths3_5c, mean(Smoothed_Deaths3_5a[x:y, 1]))
  Smoothed_Deaths3_5c = ts(Smoothed_Deaths3_5c)}
Smoothed_Deaths3_5c = data.frame(Smoothed_Deaths3_5c)
  # Tri-Daily
Smoothed_Deaths3_5d=vector()
for(i in 1:302){
  x = 3 * (i-1) + 1
  y = 3 * i
  Smoothed_Deaths3_5d <- append(Smoothed_Deaths3_5d, mean(Smoothed_Deaths3_5a[x:y, 1]))
  Smoothed_Deaths3_5d = ts(Smoothed_Deaths3_5d)}
Smoothed_Deaths3_5d = data.frame(Smoothed_Deaths3_5d)
  # Quad-Daily
Smoothed_Deaths3_5e=vector()
for(i in 1:226){
  x = 4 * (i-1) + 1
  y = 4 * i
  Smoothed_Deaths3_5e <- append(Smoothed_Deaths3_5e, mean(Smoothed_Deaths3_5a[x:y, 1]))
  Smoothed_Deaths3_5e = ts(Smoothed_Deaths3_5e)}
Smoothed_Deaths3_5e = data.frame(Smoothed_Deaths3_5e)
  # Penta-Daily
Smoothed_Deaths3_5f=vector()
for(i in 1:181){
  x = 5 * (i-1) + 1
  y = 5 * i
  Smoothed_Deaths3_5f <- append(Smoothed_Deaths3_5f, mean(Smoothed_Deaths3_5a[x:y, 1]))
  Smoothed_Deaths3_5f = ts(Smoothed_Deaths3_5f)}
Smoothed_Deaths3_5f = data.frame(Smoothed_Deaths3_5f)
  # Sext-Daily
Smoothed_Deaths3_5g=vector()
for(i in 1:151){
  x = 6 * (i-1) + 1
  y = 6 * i
  Smoothed_Deaths3_5g <- append(Smoothed_Deaths3_5g, mean(Smoothed_Deaths3_5a[x:y, 1]))
  Smoothed_Deaths3_5g = ts(Smoothed_Deaths3_5g)}
Smoothed_Deaths3_5g = data.frame(Smoothed_Deaths3_5g)


# Deaths: [April 5, 2021 - September 20, 2023]
  # Daily
Deaths3_5a = ts(covid$new_deaths[454:1352])
Deaths3_5a= data.frame(Deaths3_5a)
  # Weekly
Deaths3_5b=vector()
for(i in 1:128){
  x = 7 * (i-1) + 1
  y = 7 * i
  Deaths3_5b <- append(Deaths3_5b, mean(Deaths3_5a[x:y, 1]))
  Deaths3_5b = ts(Deaths3_5b)}
Deaths3_5b = data.frame(Deaths3_5b)
  # Bi-Daily
Deaths3_5c=vector()
for(i in 1:449){
  x = 2 * (i-1) + 1
  y = 2 * i
  Deaths3_5c <- append(Deaths3_5c, mean(Deaths3_5a[x:y, 1]))
  Deaths3_5c = ts(Deaths3_5c)}
Deaths3_5c = data.frame(Deaths3_5c)
  # Tri-Daily
Deaths3_5d=vector()
for(i in 1:299){
  x = 3 * (i-1) + 1
  y = 3 * i
  Deaths3_5d <- append(Deaths3_5d, mean(Deaths3_5a[x:y, 1]))
  Deaths3_5d = ts(Deaths3_5d)}
Deaths3_5d = data.frame(Deaths3_5d)
  # Quad-Daily
Deaths3_5e=vector()
for(i in 1:224){
  x = 4 * (i-1) + 1
  y = 4 * i
  Deaths3_5e <- append(Deaths3_5e, mean(Deaths3_5a[x:y, 1]))
  Deaths3_5e = ts(Deaths3_5e)}
Deaths3_5e = data.frame(Deaths3_5e)
  # Penta-Daily
Deaths3_5f=vector()
for(i in 1:179){
  x = 5 * (i-1) + 1
  y = 5 * i
  Deaths3_5f <- append(Deaths3_5f, mean(Deaths3_5a[x:y, 1]))
  Deaths3_5f = ts(Deaths3_5f)}
Deaths3_5f = data.frame(Deaths3_5f)
  # Sext-Daily
Deaths3_5g=vector()
for(i in 1:149){
  x = 6 * (i-1) + 1
  y = 6 * i
  Deaths3_5g <- append(Deaths3_5g, mean(Deaths3_5a[x:y, 1]))
  Deaths3_5g = ts(Deaths3_5g)}
Deaths3_5g = data.frame(Deaths3_5g)

# Mortality: [April 5, 2021 - September 27, 2023]
  # Daily
Mort3_5a = ts(covid$Mortality[454:1359])
Mort3_5a= data.frame(Mort3_5a)
  # Weekly
Mort3_5b=vector()
for(i in 1:129){
  x = 7 * (i-1) + 1
  y = 7 * i
  Mort3_5b <- append(Mort3_5b, mean(Mort3_5a[x:y, 1]))
  Mort3_5b = ts(Mort3_5b)}
Mort3_5b = data.frame(Mort3_5b)
  # Bi-Daily
Mort3_5c=vector()
for(i in 1:453){
  x = 2 * (i-1) + 1
  y = 2 * i
  Mort3_5c <- append(Mort3_5c, mean(Mort3_5a[x:y, 1]))
  Mort3_5c = ts(Mort3_5c)}
Mort3_5c = data.frame(Mort3_5c)
  # Tri-Daily
Mort3_5d=vector()
for(i in 1:302){
  x = 3 * (i-1) + 1
  y = 3 * i
  Mort3_5d <- append(Mort3_5d, mean(Mort3_5a[x:y, 1]))
  Mort3_5d = ts(Mort3_5d)}
Mort3_5d = data.frame(Mort3_5d)
  # Quad-Daily
Mort3_5e=vector()
for(i in 1:226){
  x = 4 * (i-1) + 1
  y = 4 * i
  Mort3_5e <- append(Mort3_5e, mean(Mort3_5a[x:y, 1]))
  Mort3_5e = ts(Mort3_5e)}
Mort3_5e = data.frame(Mort3_5e)
  # Penta-Daily
Mort3_5f=vector()
for(i in 1:181){
  x = 5 * (i-1) + 1
  y = 5 * i
  Mort3_5f <- append(Mort3_5f, mean(Mort3_5a[x:y, 1]))
  Mort3_5f = ts(Mort3_5f)}
Mort3_5f = data.frame(Mort3_5f)
  # Sext-Daily
Mort3_5g=vector()
for(i in 1:151){
  x = 6 * (i-1) + 1
  y = 6 * i
  Mort3_5g <- append(Mort3_5g, mean(Mort3_5a[x:y, 1]))
  Mort3_5g = ts(Mort3_5g)}
Mort3_5g = data.frame(Mort3_5g)


vect = vector()
vect = append(vect, Smoothed_Cases1a)
vect = append(vect, Smoothed_Cases1b)
vect = append(vect, Smoothed_Cases1c)
vect = append(vect, Smoothed_Cases1d)
vect = append(vect, Smoothed_Cases1e)
vect = append(vect, Smoothed_Cases1f)
vect = append(vect, Smoothed_Cases1g)
...
vect = append(vect, Smoothed_Deaths1a)
vect = append(vect, Smoothed_Deaths1b)
vect = append(vect, Smoothed_Deaths1c)
vect = append(vect, Smoothed_Deaths1d)
vect = append(vect, Smoothed_Deaths1e)
vect = append(vect, Smoothed_Deaths1f)
vect = append(vect, Smoothed_Deaths1g)
...
vect = append(vect, Smoothed_Cases2a)
vect = append(vect, Smoothed_Cases2b)
vect = append(vect, Smoothed_Cases2c)
vect = append(vect, Smoothed_Cases2d)
vect = append(vect, Smoothed_Cases2e)
vect = append(vect, Smoothed_Cases2f)
vect = append(vect, Smoothed_Cases2g)
...
vect = append(vect, Cases2g)
vect = append(vect, Smoothed_Deaths2a)
vect = append(vect, Smoothed_Deaths2b)
vect = append(vect, Smoothed_Deaths2c)
vect = append(vect, Smoothed_Deaths2d)
vect = append(vect, Smoothed_Deaths2e)
vect = append(vect, Smoothed_Deaths2f)
vect = append(vect, Smoothed_Deaths2g)
...
vect = append(vect, Mort2g)
vect = append(vect, Smoothed_Cases2_5a)
vect = append(vect, Smoothed_Cases2_5b)
vect = append(vect, Smoothed_Cases2_5c)
vect = append(vect, Smoothed_Cases2_5d)
vect = append(vect, Smoothed_Cases2_5e)
vect = append(vect, Smoothed_Cases2_5f)
vect = append(vect, Smoothed_Cases2_5g)
...
vect = append(vect, Smoothed_Deaths2_5a)
vect = append(vect, Smoothed_Deaths2_5b)
vect = append(vect, Smoothed_Deaths2_5c)
vect = append(vect, Smoothed_Deaths2_5d)
vect = append(vect, Smoothed_Deaths2_5e)
vect = append(vect, Smoothed_Deaths2_5f)
vect = append(vect, Smoothed_Deaths2_5g)
...
vect = append(vect, Smoothed_Cases3a)
vect = append(vect, Smoothed_Cases3b)
vect = append(vect, Smoothed_Cases3c)
vect = append(vect, Smoothed_Cases3d)
vect = append(vect, Smoothed_Cases3e)
vect = append(vect, Smoothed_Cases3f)
vect = append(vect, Smoothed_Cases3g)
...
vect = append(vect, Smoothed_Deaths3a)
vect = append(vect, Smoothed_Deaths3b)
vect = append(vect, Smoothed_Deaths3c)
vect = append(vect, Smoothed_Deaths3d)
vect = append(vect, Smoothed_Deaths3e)
vect = append(vect, Smoothed_Deaths3f)
vect = append(vect, Smoothed_Deaths3g)
...
vect = append(vect, Vax1_rate_3a)
vect = append(vect, Vax1_rate_3b)
vect = append(vect, Vax1_rate_3c)
vect = append(vect, Vax1_rate_3d)
vect = append(vect, Vax1_rate_3e)
vect = append(vect, Vax1_rate_3f)
vect = append(vect, Vax1_rate_3g)
vect = append(vect, Vax2_rate_3a)
vect = append(vect, Vax2_rate_3b)
vect = append(vect, Vax2_rate_3c)
vect = append(vect, Vax2_rate_3d)
vect = append(vect, Vax2_rate_3e)
vect = append(vect, Vax2_rate_3f)
vect = append(vect, Vax2_rate_3g)
vect = append(vect, Full_Vax1_rate_3a)
vect = append(vect, Full_Vax1_rate_3b)
vect = append(vect, Full_Vax1_rate_3c)
vect = append(vect, Full_Vax1_rate_3d)
vect = append(vect, Full_Vax1_rate_3e)
vect = append(vect, Full_Vax1_rate_3f)
vect = append(vect, Full_Vax1_rate_3g)
vect = append(vect, Full_Vax2_rate_3a)
vect = append(vect, Full_Vax2_rate_3b)
vect = append(vect, Full_Vax2_rate_3c)
vect = append(vect, Full_Vax2_rate_3d)
vect = append(vect, Full_Vax2_rate_3e)
vect = append(vect, Full_Vax2_rate_3f)
vect = append(vect, Full_Vax2_rate_3g)
vect = append(vect, Smoothed_Cases3_5a)
vect = append(vect, Smoothed_Cases3_5b)
vect = append(vect, Smoothed_Cases3_5c)
vect = append(vect, Smoothed_Cases3_5d)
vect = append(vect, Smoothed_Cases3_5e)
vect = append(vect, Smoothed_Cases3_5f)
vect = append(vect, Smoothed_Cases3_5g)
vect = append(vect, Cases3_5a)
vect = append(vect, Cases3_5b)
vect = append(vect, Cases3_5c)
vect = append(vect, Cases3_5d)
vect = append(vect, Cases3_5e)
vect = append(vect, Cases3_5f)
vect = append(vect, Cases3_5g)
vect = append(vect, Smoothed_Deaths3_5a)
vect = append(vect, Smoothed_Deaths3_5b)
vect = append(vect, Smoothed_Deaths3_5c)
vect = append(vect, Smoothed_Deaths3_5d)
vect = append(vect, Smoothed_Deaths3_5e)
vect = append(vect, Smoothed_Deaths3_5f)
vect = append(vect, Smoothed_Deaths3_5g)
vect = append(vect, Deaths3_5a)
vect = append(vect, Deaths3_5b)
vect = append(vect, Deaths3_5c)
vect = append(vect, Deaths3_5d)
vect = append(vect, Deaths3_5e)
vect = append(vect, Deaths3_5f)
vect = append(vect, Deaths3_5g)
vect = append(vect, Mort3_5a)
vect = append(vect, Mort3_5b)
vect = append(vect, Mort3_5c)
vect = append(vect, Mort3_5d)
vect = append(vect, Mort3_5e)
vect = append(vect, Mort3_5f)
vect = append(vect, Mort3_5g)
...
vect1 = vector()
vect1 = append(vect1, "Smoothed_Cases1a")
vect1 = append(vect1, "Smoothed_Cases1b")
vect1 = append(vect1, "Smoothed_Cases1c")
vect1 = append(vect1, "Smoothed_Cases1d")
vect1 = append(vect1, "Smoothed_Cases1e")
vect1 = append(vect1, "Smoothed_Cases1f")
vect1 = append(vect1, "Smoothed_Cases1g")
...
vect1 = append(vect1, "Smoothed_Deaths1a")
vect1 = append(vect1, "Smoothed_Deaths1b")
vect1 = append(vect1, "Smoothed_Deaths1c")
vect1 = append(vect1, "Smoothed_Deaths1d")
vect1 = append(vect1, "Smoothed_Deaths1e")
vect1 = append(vect1, "Smoothed_Deaths1f")
vect1 = append(vect1, "Smoothed_Deaths1g")
...
vect1 = append(vect1, "Smoothed_Cases2a")
vect1 = append(vect1, "Smoothed_Cases2b")
vect1 = append(vect1, "Smoothed_Cases2c")
vect1 = append(vect1, "Smoothed_Cases2d")
vect1 = append(vect1, "Smoothed_Cases2e")
vect1 = append(vect1, "Smoothed_Cases2f")
vect1 = append(vect1, "Smoothed_Cases2g")
...
vect1 = append(vect1, "Cases2g")
vect1 = append(vect1, "Smoothed_Deaths2a")
vect1 = append(vect1, "Smoothed_Deaths2b")
vect1 = append(vect1, "Smoothed_Deaths2c")
vect1 = append(vect1, "Smoothed_Deaths2d")
vect1 = append(vect1, "Smoothed_Deaths2e")
vect1 = append(vect1, "Smoothed_Deaths2f")
vect1 = append(vect1, "Smoothed_Deaths2g")
...
vect1 = append(vect1, "Mort2g")
vect1 = append(vect1, "Smoothed_Cases2_5a")
vect1 = append(vect1, "Smoothed_Cases2_5b")
vect1 = append(vect1, "Smoothed_Cases2_5c")
vect1 = append(vect1, "Smoothed_Cases2_5d")
vect1 = append(vect1, "Smoothed_Cases2_5e")
vect1 = append(vect1, "Smoothed_Cases2_5f")
vect1 = append(vect1, "Smoothed_Cases2_5g")
vect1 = append(vect1, "Cases2_5a")
vect1 = append(vect1, "Cases2_5b")
vect1 = append(vect1, "Cases2_5c")
vect1 = append(vect1, "Cases2_5d")
vect1 = append(vect1, "Cases2_5e")
vect1 = append(vect1, "Cases2_5f")
vect1 = append(vect1, "Cases2_5g")
vect1 = append(vect1, "Smoothed_Deaths2_5a")
vect1 = append(vect1, "Smoothed_Deaths2_5b")
vect1 = append(vect1, "Smoothed_Deaths2_5c")
vect1 = append(vect1, "Smoothed_Deaths2_5d")
vect1 = append(vect1, "Smoothed_Deaths2_5e")
vect1 = append(vect1, "Smoothed_Deaths2_5f")
vect1 = append(vect1, "Smoothed_Deaths2_5g")
vect1 = append(vect1, "Deaths2_5a")
vect1 = append(vect1, "Deaths2_5b")
vect1 = append(vect1, "Deaths2_5c")
vect1 = append(vect1, "Deaths2_5d")
vect1 = append(vect1, "Deaths2_5e")
vect1 = append(vect1, "Deaths2_5f")
vect1 = append(vect1, "Deaths2_5g")
...
vect1 = append(vect1, "Smoothed_Cases3a")
vect1 = append(vect1, "Smoothed_Cases3b")
vect1 = append(vect1, "Smoothed_Cases3c")
vect1 = append(vect1, "Smoothed_Cases3d")
vect1 = append(vect1, "Smoothed_Cases3e")
vect1 = append(vect1, "Smoothed_Cases3f")
vect1 = append(vect1, "Smoothed_Cases3g")
...
vect1 = append(vect1, "Smoothed_Deaths3a")
vect1 = append(vect1, "Smoothed_Deaths3b")
vect1 = append(vect1, "Smoothed_Deaths3c")
vect1 = append(vect1, "Smoothed_Deaths3d")
vect1 = append(vect1, "Smoothed_Deaths3e")
vect1 = append(vect1, "Smoothed_Deaths3f")
vect1 = append(vect1, "Smoothed_Deaths3g")
...
vect1 = append(vect1, "Vax1_rate_3a")
vect1 = append(vect1, "Vax1_rate_3b")
vect1 = append(vect1, "Vax1_rate_3c")
vect1 = append(vect1, "Vax1_rate_3d")
vect1 = append(vect1, "Vax1_rate_3e")
vect1 = append(vect1, "Vax1_rate_3f")
vect1 = append(vect1, "Vax1_rate_3g")
vect1 = append(vect1, "Vax2_rate_3a")
vect1 = append(vect1, "Vax2_rate_3b")
vect1 = append(vect1, "Vax2_rate_3c")
vect1 = append(vect1, "Vax2_rate_3d")
vect1 = append(vect1, "Vax2_rate_3e")
vect1 = append(vect1, "Vax2_rate_3f")
vect1 = append(vect1, "Vax2_rate_3g")
vect1 = append(vect1, "Full_Vax1_rate_3a")
vect1 = append(vect1, "Full_Vax1_rate_3b")
vect1 = append(vect1, "Full_Vax1_rate_3c")
vect1 = append(vect1, "Full_Vax1_rate_3d")
vect1 = append(vect1, "Full_Vax1_rate_3e")
vect1 = append(vect1, "Full_Vax1_rate_3f")
vect1 = append(vect1, "Full_Vax1_rate_3g")
vect1 = append(vect1, "Full_Vax2_rate_3a")
vect1 = append(vect1, "Full_Vax2_rate_3b")
vect1 = append(vect1, "Full_Vax2_rate_3c")
vect1 = append(vect1, "Full_Vax2_rate_3d")
vect1 = append(vect1, "Full_Vax2_rate_3e")
vect1 = append(vect1, "Full_Vax2_rate_3f")
vect1 = append(vect1, "Full_Vax2_rate_3g")
vect1 = append(vect1, "Smoothed_Cases3_5a")
vect1 = append(vect1, "Smoothed_Cases3_5b")
vect1 = append(vect1, "Smoothed_Cases3_5c")
vect1 = append(vect1, "Smoothed_Cases3_5d")
vect1 = append(vect1, "Smoothed_Cases3_5e")
vect1 = append(vect1, "Smoothed_Cases3_5f")
vect1 = append(vect1, "Smoothed_Cases3_5g")
vect1 = append(vect1, "Cases3_5a")
vect1 = append(vect1, "Cases3_5b")
vect1 = append(vect1, "Cases3_5c")
vect1 = append(vect1, "Cases3_5d")
vect1 = append(vect1, "Cases3_5e")
vect1 = append(vect1, "Cases3_5f")
vect1 = append(vect1, "Cases3_5g")
vect1 = append(vect1, "Smoothed_Deaths3_5a")
vect1 = append(vect1, "Smoothed_Deaths3_5b")
vect1 = append(vect1, "Smoothed_Deaths3_5c")
vect1 = append(vect1, "Smoothed_Deaths3_5d")
vect1 = append(vect1, "Smoothed_Deaths3_5e")
vect1 = append(vect1, "Smoothed_Deaths3_5f")
vect1 = append(vect1, "Smoothed_Deaths3_5g")
vect1 = append(vect1, "Deaths3_5a")
vect1 = append(vect1, "Deaths3_5b")
vect1 = append(vect1, "Deaths3_5c")
vect1 = append(vect1, "Deaths3_5d")
vect1 = append(vect1, "Deaths3_5e")
vect1 = append(vect1, "Deaths3_5f")
vect1 = append(vect1, "Deaths3_5g")
vect1 = append(vect1, "Mort3_5a")
vect1 = append(vect1, "Mort3_5b")
vect1 = append(vect1, "Mort3_5c")
vect1 = append(vect1, "Mort3_5d")
vect1 = append(vect1, "Mort3_5e")
vect1 = append(vect1, "Mort3_5f")
vect1 = append(vect1, "Mort3_5g")
...
log = list()
sqrt = list()
Data <- data.frame(matrix(ncol=24, nrow=4872))
...
# This bring the total number of models being evaluated to 480.
  ...
  for(j in 1:length(transform)){
    ...
    for(k in 1:length(list)){
      ...
      if(Data[x, 9] <= 0.05){
        Data$Pass[x] = 1 + Data$Pass[x]}
      if(Data[x, 9] <= 0.05 & Data[x, 10] >= 0.05){
        Data$Pass[x] = Data$Pass[x] - 1}
      ...
      if(substr(Data$Variance_test[x], -1, 0) %in% c("1","2")){
        Data$Pass[x] = Data$Pass[x] + 1}
      if(substr(Data$Variance_test[x], -1, 0) %in% c("4","5")){
        Data$Pass[x] = Data$Pass[x]}
      if(substr(Data$Variance_test[x], -1, 0) == "3"){
        Data$Pass[x] = Data$Pass[x] + 0.5}
      # if(Data$Pass[x] >= 6){
      ...
      for(s in 11:13){
        if(Data[x,s] >= 0.05){
          Pass1 = Pass1 + 1}}
      if(Pass1 >= 3){
        Data$Residual_Tests[x] = "Pass3"
        Data$Pass[x] = Data$Pass[x] + 3}
      if(Pass1 > 1 & Pass1 < 3){
        Data$Residual_Tests[x] = "Pass2"
        Data$Pass[x] = Data$Pass[x] + 2}
      if(Pass1 > 0 & Pass1 < 2){
        Data$Residual_Tests[x] = "Pass1"
        Data$Pass[x] = Data$Pass[x] + 1}
      if(Pass1 == 0){
...
# This bring the total number of models being evaluated to 480.
  ...
  for(j in 1:length(transform)){
    ...
    for(k in 1:length(list)){
      ...
      ok = list[k]
      while(Data_aa$Stationarity_Tests[x] %in% c("Fail", NA)){
        if(ok==0){
      ...
      Data_aa$Pass[x]=0
      if(Data_aa[x,7]>=0.05 | Data_aa[x,8]>=0.05){
        Data_aa$Pass[x] = 1 + Data_aa$Pass[x]}
      if(Data_aa[x, 9] <= 0.05 | Data_aa[x,10]>=0.05){
        Data_aa$Pass[x] = 1 + Data_aa$Pass[x]}
      for(z in 11:13){
        if(Data_aa[x,z] >= 0.05){
...
for(i in 1:2112){
  Dict2[Data_aa$Name[i]] = Difference2[[i]]}
...
Stat_Norm_Pass_aa = subset(Stat_Norm_aa, Stat_Norm_aa$Pass >=3)
Stat_Res_aa = subset(Stationarity_aa, Stationarity_aa$Residual_Tests != "Fail")
Stat_Res_Pass_aa = subset(Stat_Res_aa, Stat_Res_aa$Pass >=3)
...
forecast <- sarima.for(Dict2["Mort2_5b.bc1(1.7)"], n.ahead=12, d=0, q=1, p=1)
x = predict(arima, h=3)
plot(x)
x$pred
Dict1["Mort2b.bc(0)"][1]
...
plot(thetaf(arima$residuals, h = 12, level = 95))

original = bxcx(arima$residuals, InverseQ = TRUE, lambda = lambda)

ts.plot(Mortality, xlim=c(1,length(Mortality)+12), ylim = c(min(Mortality),max(U.tr)))
lines(U.tr, col="blue", lty="dashed")
lines(L.tr, col="blue", lty="dashed")
sarima.for(Dict2["Mort2_5b.bc1(1.7)"], 111, 1,0,1)
lambda
Dict["Mort2b.bc"]
# Best = "Vax3b(1,1,0)(0,1,0)_7"
...
bcTransform <- boxcox(vect[[55]]~ as.numeric(1:length(vect[[55]])))       # plot the graph
  ...
  bcTransform$x[which(bcTransform$y == max(bcTransform$y))] # gives the value of λ
  lambda=bcTransform$x[which(bcTransform$y == max(bcTransform$y))]
  title(main = paste0(vect1[55], "  lambda = ", round(lambda, 3)))
  lambda
LAMBDA = 1/lambda
  Mort2_5b.bc1(1.7)
...
```{r}
nsdiffs(Difference[[1]])

z = ts(vect[[29]], frequency = 365, start = c(2020, 5))
z
z = ts(vect[[29]], frequency = 365/7, start = c(2020, 8/7))
z
ndiffs(z)
y=acf2(Difference[[677]])
y=acf2(Difference[[674]])
x = arima(Difference[[674]], order = c(0,0,0), seasonal = list(order = c(0,1,0), period = 7))
y=acf2(x$residuals)
x = arima(Difference[[674]], order = c(0,1,0), seasonal = list(order = c(0,1,0), period = 7))
y=acf2(x$residuals)
x = arima(Difference[[674]], order = c(1,1,0), seasonal = list(order = c(0,1,0), period = 7))
y=acf2(x$residuals)
x = arima(Difference[[674]], order = c(0,1,1), seasonal = list(order = c(0,1,0), period = 7))
y=acf2(x$residuals)



x = arima(Difference[[677]], order = c(0,0,0), seasonal = list(order = c(1,1,0), period = 7))
acf2(x$residuals)
x = arima(Difference[[677]], order = c(1,0,0), seasonal = list(order = c(1,0,0), period = 7))
acf2(x$residuals)
x = arima(Difference[[677]], order = c(1,0,1), seasonal = list(order = c(1,0,0), period = 7))
acf2(x$residuals)
x = arima(Difference[[677]], order = c(1,1,1), seasonal = list(order = c(1,0,0), period = 7))
acf2(x$residuals)
x = arima(Difference[[674]], order = c(1,2,1), seasonal = list(order = c(1,1,0), period = 7))
acf2(x$residuals)
auto.arima
...
Data1 = data.frame(matrix(nrow=3456, ncol=2))
colnames(Data1) = c("Model", "AICc")

loop.s = c(7)
loop.p = c(0,1,2,3)
loop.d = c(0,1,2,3,4,5,6,7)
loop.q = c(0,1,2,3)
loop.P = c(1,2)
loop.Q = c(0,1,2)
loop.D = c(1,2)
    ...
    for(Q in loop.Q){
      for(P in loop.P){
        for(d in loop.d){
          for(q in loop.q){
            for(p in loop.p){
                Data1[i, 1] = paste0("SARIMA(", p, ",", d, ",", q, ")x(", P, ",", D, ",", Q, ")_", s)
                assign(paste0("SARIMA(", p, ",", d, ",", q, ")x(", P, ",", D, ",", Q, ")_", s), 
                       try(arima(vect[[29]], order=c(p,d,q), seasonal=list(order=c(P,D,Q), period=s), method="ML")))
                Data1[i, 2] = try(AIC(get(paste0("SARIMA(", p, ",", d, ",", q, ")x(", P, ",", D, ",", Q, ")_", s))))
                x=try(acf2(get(paste0("SARIMA(", p, ",", d, ",", q, ")x(", P, ",", D, ",", Q, ")_", s))$residuals, 
                       main = paste0("SARIMA(", p, ",", d, ",", q, ")x(", P, ",", D, ",", Q, ")_", s, "  AICc = ", Data1[i,2])))
                i = i + 1
                }
              }}}}}}
...
i = 1
for(x in 1:length(Difference)){
  min = vector()
  if(ar(Difference[[x]], aic = TRUE, order.max = NULL, method = c("yule-walker"))$order > 0){
    min = append(min, ar(Difference[[x]], aic = TRUE, order.max = NULL, method = c("yule-walker"))$order)}
  if(ar(Difference[[x]], aic = TRUE, order.max = NULL, method = c("mle"))$order > 0){
    min = append(min, ar(Difference[[x]], aic = TRUE, order.max = NULL, method = c("mle"))$order)}
  if(ar(Difference[[x]], aic = TRUE, order.max = NULL, method = c("ols"))$order > 0){
    min = append(min, ar(Difference[[x]], aic = TRUE, order.max = NULL, method = c("ols"))$order)}
  if(ar(Difference[[x]], aic = FALSE, order.max = NULL, method = c("yule-walker"))$order > 0){
    min = append(min, ar(Difference[[x]], aic = FALSE, order.max = NULL, method = c("yule-walker"))$order)}
  if(ar(Difference[[x]], aic = FALSE, order.max = NULL, method = c("mle"))$order > 0){
    min = append(min, ar(Difference[[x]], aic = FALSE, order.max = NULL, method = c("mle"))$order)}
  if(ar(Difference[[x]], aic = FALSE, order.max = NULL, method = c("ols"))$order > 0){
    min = append(min, ar(Difference[[x]], aic = FALSE, order.max = NULL, method = c("ols"))$order)}
  min1 = sort(min)[1]
  ...
  if(Data_a$Differencing[[number]] == "Lag = 1, Period = 7"){
    s = 7
    d = 1
    D = 1}
  if(Data_a$Differencing[[number]] == "Lag = 1, Period = 12"){
    s = 12
    d = 1
    D = 1}
  if(Data_a$Differencing[[number]] == "Lag = 1, Period = none"){
    s = 0
    d = 1
    D = 0}
  if(Data_a$Differencing[[number]] == "Lag = none, Period = 7"){
    s = 7
    d = 0
    D = 1}
  if(Data_a$Differencing[[number]] == "Lag = none, Period = 12"){
    s = 12
    d = 0
    D = 1}
