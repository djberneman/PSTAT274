...
arima(Mortality, order=c(0,1,1), seasonal = list(order = c(0,1,1), period = 12), method="ML")
ma1 sma1 -0.3484 -0.5622
s.e. 0.0943 0.0774
sigma^2 estimated as 0.001313: log likelihood = 223.63, aic = -441.26
AICc(arima(Mortality, order=c(0,1,1), seasonal = list(order = c(0,1,1), period = 12), method="ML")) [1] -441.1664
arima(Mortality, order=c(0,1,3), seasonal = list(order = c(0,1,1), period = 12), method="ML") ma1 ma2 ma3 sma1
-0.3563 0.0802 -0.1967 -0.5799
s.e. 0.0892 0.1078 0.0978 0.0798
sigma^2 estimated as 0.001263: log likelihood = 225.66, aic = -441.32
